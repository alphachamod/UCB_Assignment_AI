...
name_input = st.sidebar.text_input("Enter the name:")
name_type = st.sidebar.selectbox("Type:", ["Staff", "Visitor", "Special"])

# Place the button in a sidebar
capture_button = st.sidebar.button("Capture 50 Faces")
...
def capture_faces(name):
    ...
    # Reset input field and dropdown after capturing and saving
    name_input = None
    name_type = None

    # Reset name field after capturing and saving
